...
@section('content')
    ...
    {!! Form::open(['url' => 'games']) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::select('event_id', $eventList, null, ['class' => 'form-control']) !!}                    
        </div>

        {{--  Team 1 select field  --}}
        <div class="form-group">
            {!! Form::label('team1_id', 'Team 1:') !!}
            {!! Form::select('team1_id', $teamList, null, ['class' => 'form-control']) !!}
        </div>

        {{--  Team 2 select field  --}}
        <div class="form-group">
            {!! Form::label('team2_id', 'Team 2:') !!}
            {!! Form::select('team2_id', $teamList, null, ['class' => 'form-control']) !!}
        </div>
